...
class AuthenticationBloc
  ...
  Future<void> _loginWithPasswordEventHandler(
      LoginWithPasswordEvent event, Emitter<AuthenticationState> emit) async {
  ...
  Future<void> _loginWithPhoneEventHandler(
      LoginWithPhoneEvent event, Emitter<AuthenticationState> emit) async {
